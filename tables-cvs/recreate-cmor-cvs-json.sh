...
ESGVOC_REVISION="${ESGVOC_REVISION:=e9c991c}" # v2.2.1
UNIVERSE_CVS_FORK="${UNIVERSE_CVS_FORK:=znichollscr}"
UNIVERSE_CVS_BRANCH="${UNIVERSE_CVS_BRANCH:=update-aerchemmip-scenariomip}"
CMIP7_CVS_FORK="${CMIP7_CVS_FORK:=WCRP-CMIP}"
CMIP7_CVS_BRANCH="${CMIP7_CVS_BRANCH:=more-entries}"
# ESGVOC_FORK="${ESGVOC_FORK:=ESGF}"
